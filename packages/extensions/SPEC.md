# SPEC — `@openmeta/extensions`

> **Implementation contract.** Implement against this document. [README](./README.md) is the short overview.

**Status:** ✅ Phase 12 · `v0.11.0-beta` (Extension SDK — per revised roadmap; supersedes the Phase 14 numbering in [ADR-0026](../../docs/adr/ADR-0026-complete-framework-ecosystem.md))
...
packages/extensions/src/
  ...
  Exceptions/     ExtensionsException + typed subclasses
...
| Integration | Boot the framework with `ExtensionsServiceProvider`, seed discovery, and bootstrap extensions in dependency order (`tests/Integration`) |
